...
(function($, window, document) {
  ...
  $.fn.owlCarousel.options = {
    ...
    navigation: false,
    navigationText: [
      "<span class='glyphicon glyphicon-chevron-left' aria-hidden='true' style='position: relative; top: 1px;'></span>",
      "<span class='glyphicon glyphicon-chevron-right' aria-hidden='true' style='position: relative; top: 1px;'></span>"
    ],
    rewindNav: true,
    scrollPerPage: false,
